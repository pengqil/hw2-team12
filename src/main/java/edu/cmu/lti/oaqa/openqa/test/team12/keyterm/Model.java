...
public class Model {
    ...
    /*
    public CRF4 loadAndRetrieveModelFromClassPathResource(String modelPath, Class c) throws LoadModelException {
        InputStream is = null;
    ...
    */
    public CRF4 loadAndRetrieveModel(String modelLocation) throws LoadModelException {
        InputStream is = null;
    ...
    public CRF4 loadAndRetrieveModel(InputStream is) throws LoadModelException {
